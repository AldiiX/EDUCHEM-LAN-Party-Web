...
export const TextWithIcon = ({ text, iconSrc, iconSize = 14, textSize = 16, className, color = "var(--text-color)", onClick, gapBetween = 8 }: TextWithIconProps) => {
    ...
    return (
        <div className={classes.join(" ")} onClick={onClick} style={{ gap: gapBetween }}>
